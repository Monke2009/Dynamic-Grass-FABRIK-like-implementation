...
Why the chunks?:
    ...
    - O(checking_local_blades + Chunks*Local_baldes)

    - For this version, i did not have grass-to-grass collision -> O(n) for all 3 checking chunks because you dont have to iterate through every blades in that chunk multiple times
